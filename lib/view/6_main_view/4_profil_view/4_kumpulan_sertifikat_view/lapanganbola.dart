...
class lapanganbola extends StatefulWidget {
  final AnimationController? anim;
  const lapanganbola({@required this.anim});
  @override
  _lapanganbolaState createState() => _lapanganbolaState();
}

class _lapanganbolaState extends State<lapanganbola>
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderLapBola(context, tweenValue: headerTween.value),
          ),

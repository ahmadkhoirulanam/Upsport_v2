...
import 'package:sport/view/6_main_view/4_profil_view/3_riwayat_materi_view/widget/header_lapangan_tenis.dart';
...
import 'package:sport/view/6_main_view/4_profil_view/4_kumpulan_sertifikat_view/widget/lap_tenis_card.dart';
...
class lapangantenis extends StatefulWidget {
  final AnimationController? anim;
  const lapangantenis({@required this.anim});
  @override
  _lapangantenisState createState() => _lapangantenisState();
}

class _lapangantenisState extends State<lapangantenis>
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderLapTenis(context, tweenValue: headerTween.value),
          ),

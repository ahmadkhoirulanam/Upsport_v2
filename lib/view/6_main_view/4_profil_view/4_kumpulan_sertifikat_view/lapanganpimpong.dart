...
import 'package:sport/view/6_main_view/4_profil_view/3_riwayat_materi_view/widget/header_lapangan_pimpong.dart';
...
import 'package:sport/view/6_main_view/4_profil_view/4_kumpulan_sertifikat_view/widget/lap_pimpong_card.dart';
...
class lapanganpimpong extends StatefulWidget {
  final AnimationController? anim;
  const lapanganpimpong({@required this.anim});
  @override
  _lapanganpimpongState createState() => _lapanganpimpongState();
}

class _lapanganpimpongState extends State<lapanganpimpong>
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderLapPimpong(context, tweenValue: headerTween.value),
          ),

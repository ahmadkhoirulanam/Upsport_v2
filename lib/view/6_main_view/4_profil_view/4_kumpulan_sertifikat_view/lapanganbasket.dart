...
class lapanganbasket extends StatefulWidget {
  final AnimationController? anim;
  const lapanganbasket({@required this.anim});
  @override
  _lapanganbasketState createState() => _lapanganbasketState();
}

class _lapanganbasketState extends State<lapanganbasket>
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderLapBasket(context, tweenValue: headerTween.value),
          ),

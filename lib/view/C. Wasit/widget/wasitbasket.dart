...
import 'package:sport/view/B.%20Pelatih/widget/header_pelatih_basket.dart';
...
import 'package:sport/view/C.%20Wasit/widget/header_wasit_basket.dart';
import 'package:sport/view/C.%20Wasit/widget/wasit_futsal_card_list.dart';

class WasitBasket extends StatefulWidget {
  final AnimationController? anim;
  const WasitBasket({@required this.anim});
  @override
  _WasitBasketState createState() => _WasitBasketState();
}

class _WasitBasketState extends State<WasitBasket>
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderWasitBasket(context, tweenValue: headerTween.value),
          ),

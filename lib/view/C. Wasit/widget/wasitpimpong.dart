...
class WasitPimpong extends StatefulWidget {
  final AnimationController? anim;
  const WasitPimpong({@required this.anim});
  @override
  _WasitPimpongState createState() => _WasitPimpongState();
}

class _WasitPimpongState extends State<WasitPimpong>

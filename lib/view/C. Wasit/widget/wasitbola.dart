...
import 'package:sport/view/C.%20Wasit/widget/header_wasit_bola.dart';
import 'package:sport/view/C.%20Wasit/widget/wasit_futsal_card_list.dart';

class WasitBola extends StatefulWidget {
  final AnimationController? anim;
  const WasitBola({@required this.anim});
  @override
  _WasitBolaState createState() => _WasitBolaState();
}

class _WasitBolaState extends State<WasitBola> with TickerProviderStateMixin {
      ...
      body: Stack(
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) => mainHeaderWasitSepakBola(context,

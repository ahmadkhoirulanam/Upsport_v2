...
import 'package:sport/view/C.%20Wasit/widget/header_wasit_bulu.dart';
import 'package:sport/view/C.%20Wasit/widget/wasit_futsal_card_list.dart';

class WasitBulu extends StatefulWidget {
  final AnimationController? anim;
  const WasitBulu({@required this.anim});
  @override
  _WasitBuluState createState() => _WasitBuluState();
}

class _WasitBuluState extends State<WasitBulu> with TickerProviderStateMixin {
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderWasitBulu(context, tweenValue: headerTween.value),
          ),

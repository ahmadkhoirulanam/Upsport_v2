...
import 'package:sport/view/C.%20Wasit/widget/header_wasit_tenis.dart';
import 'package:sport/view/C.%20Wasit/widget/wasit_futsal_card_list.dart';

class WasitTenis extends StatefulWidget {
  final AnimationController? anim;
  const WasitTenis({@required this.anim});
  @override
  _WasitTenisState createState() => _WasitTenisState();
}

class _WasitTenisState extends State<WasitTenis> with TickerProviderStateMixin {
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderWasitTenis(context, tweenValue: headerTween.value),
          ),

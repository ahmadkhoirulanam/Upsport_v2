...
import 'package:sport/view/C.%20Wasit/widget/header_wasit_futsal.dart';
import 'package:sport/view/C.%20Wasit/widget/wasit_futsal_card_list.dart';

class WasitFutsal extends StatefulWidget {
  final AnimationController? anim;
  const WasitFutsal({@required this.anim});
  @override
  _WasitFutsalState createState() => _WasitFutsalState();
}

class _WasitFutsalState extends State<WasitFutsal>
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderWasitFutsal(context, tweenValue: headerTween.value),
          ),

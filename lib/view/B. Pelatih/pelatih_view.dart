...
class Pelatih extends StatefulWidget {
  final AnimationController? anim;
  const Pelatih({@required this.anim});
  @override
  _PelatihState createState() => _PelatihState();
}

class _PelatihState extends State<Pelatih> with TickerProviderStateMixin {
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderPelatih(context, tweenValue: headerTween.value),
          ),

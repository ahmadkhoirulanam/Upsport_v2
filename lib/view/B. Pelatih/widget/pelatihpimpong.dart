...
class PelatihPimpong extends StatefulWidget {
  final AnimationController? anim;
  const PelatihPimpong({@required this.anim});
  @override
  _PelatihPimpongState createState() => _PelatihPimpongState();
}

class _PelatihPimpongState extends State<PelatihPimpong>
  ...
  final List<String> namaList = ['Syaeful', 'Aji santoso'];
  final List<String> nowaList = ['+6281388428267', '+6281215265282'];
  final List<String> lisensiList = ['Nasional', 'Daerah (Kota/Kabupaten)'];
  final List<String> lokasiList = ['kota pekalongan', 'Kabupaten Demak'];
  final List<String> clubiList = ['Club Alaska Pekalongan', 'PTM ELECTRA'];
      ...
      body: Stack(
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) => mainHeaderPelatihPimpong(context,

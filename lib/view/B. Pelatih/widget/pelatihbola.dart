...
import 'package:sport/view/B.%20Pelatih/widget/header_pelatih_bola.dart';
...
class PelatihBola extends StatefulWidget {
  final AnimationController? anim;
  const PelatihBola({@required this.anim});
  @override
  _PelatihBolaState createState() => _PelatihBolaState();
}

class _PelatihBolaState extends State<PelatihBola>
  ...
  final List<String> namaList = ['Meica Henriyana S.Pd'];
  final List<String> nowaList = ['+6285258299064'];
  final List<String> lisensiList = ['Nasional'];
  final List<String> lokasiList = ['Kabupaten Sragen'];
  final List<String> clubiList = ['Walisongo Islamic Football Academy'];
      ...
      body: Stack(
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) => mainHeaderPelatihSepakBola(
                context,

...
class PelatihBasket extends StatefulWidget {
  final AnimationController? anim;
  const PelatihBasket({@required this.anim});
  @override
  _PelatihBasketState createState() => _PelatihBasketState();
}

class _PelatihBasketState extends State<PelatihBasket>
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderPelatihBasket(context, tweenValue: headerTween.value),
          ),

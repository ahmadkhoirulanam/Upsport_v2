...
Widget mainHeaderPelatihBulu(BuildContext context,
    {@required double? tweenValue}) {
  return Align(
    alignment: Alignment.topCenter,
    child: WidgetTween(
      y: tweenValue! * -getW(context, 0.1),
      opacity: 1.0 - tweenValue,
      child: Container(
        height: getW(context, 0.35),
        color: Warna().backgroundColor(),
        padding: EdgeInsets.only(top: getW(context, 0.01)),
        child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: CustomTextField(
                      styleId: 2,
                      height: 0.09,
                      hint2: "Cari Pelatih Bulu Tangkis",

...
class PelatihFutsal extends StatefulWidget {
  final AnimationController? anim;
  const PelatihFutsal({@required this.anim});
  @override
  _PelatihFutsalState createState() => _PelatihFutsalState();
}

class _PelatihFutsalState extends State<PelatihFutsal>
  ...
  final List<String> namaList = [
    ...
    'Aditya sarpono',
    'Angga Yudha Perdana',
    'Muhammad Yusuf Habibi, S.Pd.',
    'Wahyu Aji Sukarno',
    'ABDY WINDIARTHA',
    'Meica Henriyana S.Pd'
  ];
  ...
  final List<String> clubiList = [
    '-',
    'Futsal kota Surakarta',
    'NTB BOYS',
    'Futsal Espero',
    'Boyolali FC ',
    'FAFAGE FUTSAL AKADEMI BANJARNEGARA',
    'Walisongo Islamic Football Academy'
  ];
        ...
        children: [
          AnimatedBuilder(
            ...
            builder: (context, widgetState) =>
                mainHeaderPelatihFutsal(context, tweenValue: headerTween.value),
          ),
